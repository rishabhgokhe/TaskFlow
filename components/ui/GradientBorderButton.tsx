...
export default function GradientBorderButton({link, name}: {link: string, name: string}) {
  return (
    <button className="relative px-0.5 py-0.5 inline-flex h-10 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 ml-2 transition-transform transform hover:scale-105">
